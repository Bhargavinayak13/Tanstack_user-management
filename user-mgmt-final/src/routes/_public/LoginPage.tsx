...
//       setServerError("");
//       try {
//         const data = await loginApi(value.username,value.password);
//         setAuth(
//           {
//             id: data.id,
...
//           </p>
//           {/* <p style={{ color: "var(--text-muted)", fontSize: "0.78rem", marginTop: "0.5rem", background: "var(--accent-muted)", padding: "0.4rem 0.75rem", borderRadius: "4px" }}>
